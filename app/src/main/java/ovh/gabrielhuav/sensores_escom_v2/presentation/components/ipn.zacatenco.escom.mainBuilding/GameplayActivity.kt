...
<<<<<<< HEAD
                        "escom" -> startESCOMActivity()
                        "metro" -> startMETROActivity()
                        "casa" -> startCASAActivity()
=======
...
<<<<<<< HEAD
    private fun startESCOMActivity() {
        val intent = Intent(this, escom::class.java).apply {
            putExtra("PLAYER_NAME", playerName)
            putExtra("IS_SERVER", gameState.isServer)
            putExtra("INITIAL_POSITION", Pair(1, 1))
            putExtra("PREVIOUS_POSITION", gameState.playerPosition) // Guarda la posición actual
    ...
    private fun startCASAActivity() {
        val intent = Intent(this, casa::class.java).apply {
=======
...
>>>>>>> 89170fe2e89080d6ad31f02efc4c5de74165051a
    ...
    private fun checkPositionForMapChange(position: Pair<Int, Int>) {
        ...
        when {
            position.first == 2 && position.second == 19 -> {
                canChangeMap = true
                targetDestination = "escom"
                runOnUiThread {
                    Toast.makeText(this, "Presiona A para entrar al ESCOM", Toast.LENGTH_SHORT).show()
                }
            }
<<<<<<< HEAD
            position.first == 2 && position.second == 26 -> {
=======
...
<<<<<<< HEAD
            position.first == 36 && position.second == 23 -> {
                canChangeMap = true
            ...
            position.first == 36 && position.second == 27 -> {
                canChangeMap = true
                targetDestination = "metro"
                runOnUiThread {
                    Toast.makeText(this, "Presiona A para entrar al Metro", Toast.LENGTH_SHORT).show()
